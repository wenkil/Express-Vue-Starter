<template>
  <div>
    <el-dialog
      ...
      :show-close="false"
      :title="openType == 1 ? '新增客户' : '编辑客户'"
      :visible.sync="addModel"
      width="1000px">
      <el-form v-loading="modelLoading" :model="form" :rules="rulers" ref="form" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="客户名称" prop="crm_user_name">
              <el-input v-model.trim="form.crm_user_name" maxlength="30"></el-input>
            </el-form-item>
            <el-form-item label="手机号" prop="crm_user_phone">
              <el-input v-model.trim="form.crm_user_phone" maxlength="11"></el-input>
            </el-form-item>
            <el-form-item label="客户行业" prop="crm_user_trade">
              <el-select
                style="width: 360px"
                v-model="form.crm_user_trade">
                <el-option
          ...
          <el-col :span="12">
            ...
            <el-form-item label="邮箱" prop="crm_user_mail">
              <el-input v-model.trim="form.crm_user_mail"></el-input>
            </el-form-item>
            <el-form-item label="客户等级" prop="crm_user_level">
              <el-select
                style="width: 360px"
                v-model="form.crm_user_level">
                <el-option
...
<!--            </el-form-item>-->
        ...
        <el-form-item label="地址" prop="crm_user_address">
          <el-input v-model.trim="form.crm_user_address" maxlength="50"></el-input>
        </el-form-item>
